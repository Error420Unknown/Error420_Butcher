...
---------------------- Callbacks ----------------------
QBCore.Functions.CreateCallback('Error420_Butcher:get:PluckedChicken', function(source, cb)
    local src = source
...
QBCore.Functions.CreateCallback('Error420_Butcher:get:ProcessedChicken', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('Error420_Butcher:get:ChickenBreast', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('Error420_Butcher:get:ChickenThighs', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('Error420_Butcher:get:ChickenDrumsticks', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('Error420_Butcher:get:ChickenWings', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
QBCore.Functions.CreateCallback('Error420_Butcher:get:ChickenLegs', function(source, cb)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
...
---------------------- Events ----------------------
RegisterNetEvent('Error420_Butcher:server:GiveItems', function(args, amount)
...
RegisterNetEvent('Error420_Butcher:server:PluckChicken', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if InvType == 'qb' then
...
RegisterNetEvent('Error420_Butcher:server:ProcessChicken', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if InvType == 'qb' then
...
RegisterNetEvent('Error420_Butcher:server:ProcessChickenBreast', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if InvType == 'qb' then        
...
RegisterNetEvent('Error420_Butcher:server:ProcessChickenThighs', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if InvType == 'qb' then
        if exports['qb-inventory']:RemoveItem(src, 'processedchicken', 1, false, false, nil) then
...
RegisterNetEvent('Error420_Butcher:server:ProcessChickenWings', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if InvType == 'qb' then
        if exports['qb-inventory']:RemoveItem(src, 'processedchicken', 1, false, false, nil) then
...
RegisterNetEvent('Error420_Butcher:server:ProcessChickenDrumSticks', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if InvType == 'qb' then
        if exports['qb-inventory']:RemoveItem(src, 'processedchicken', 1, false, false, nil) then
...
RegisterNetEvent('Error420_Butcher:server:ProcessChickenLegs', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if InvType == 'qb' then 
        if exports['qb-inventory']:RemoveItem(src, 'processedchicken', 1, false, false, nil) then
...
RegisterNetEvent('Error420_Butcher:server:PackChickenBreast', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if InvType == 'qb' then 
...
RegisterNetEvent('Error420_Butcher:server:PackChickenThighs', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src) 
    if InvType == 'qb' then
...
RegisterNetEvent('Error420_Butcher:server:PackChickenWings', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src) 
    if InvType == 'qb' then
...
RegisterNetEvent('Error420_Butcher:server:PackChickenDrumSticks', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if InvType == 'qb' then 
...
RegisterNetEvent('Error420_Butcher:server:PackChickenLegs', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src) 
    if InvType == 'qb' then
...
---------------------- Selling ----------------------
RegisterNetEvent('Error420_Butcher:server:SellItems', function(args)
    local args = tonumber(args)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
    if not Player then return end
